...
(function($) {
    ...
    var password_Strength = new function() {
        ...
        this.getStrengthInfo = function(passwordVal) {
            ...
            if ((specials + uppers + nums) < password_settings.minLength) {
                msg += password_settings.minLength - (specials + uppers + nums) + " more characters, ";
            }

            //at the "at least" at the front
            if (specials == 0 || uppers == 0 || nums == 0) {
                msg += "At least ";
            }
    ...
    $.fn.password_strength = function(options) {
        ...
        return this.each(function() {
            ...
            var container = $('<span class="PasswordStrengthText"></span>');

            //add the container next to textbox
            $('.psswdValidateStatus').html(container);
            ...
            .eq(0).css({ height: 3, 'border-style': 'solid', 'border-width': 1, padding: 2 }).end()
            .eq(1).css({ height: 5 }).end();
