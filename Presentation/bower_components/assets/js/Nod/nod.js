(function ($) {
    ...
    Listener = (function () {
        ...
        Listener.prototype.destroy = function () {
            ...
            if (this.$el.attr('type') === 'radio') {
                ...
                if (this.get.delay) {
                    ...
                    return this.$el.off('blur', '**', this.eventHandlers.blur);
                    return this.$el.off('focus', '**', this.eventHandlers.focus);
                }
            }
        };
        ...
        Listener.prototype.events = function () {
            ...
            this.eventHandlers['blur'] = this.delayedCheck;
            this.eventHandlers['focus'] = this.delayedCheck;
            if (this.$el.attr('type') === 'radio') {
                ...
                this.$el.on('focus', this.eventHandlers.focus);
                if (this.field[1] === 'one-of') {
                    $(window).on('nod-run-one-of', this.eventHandlers.window);
                }
                if (this.get.delay) {
                    return this.$el.on('keyup', this.eventHandlers.keyup);
                    return this.$el.on('blur', this.eventHandlers.blur);
                    return this.$el.on('focus', this.eventHandlers.focus);
                }
            }
        };
    ...
    Msg = (function () {
        ...
        Msg.prototype.createMsg = function (msg) {
            ...
            return $('<i/>', {
                'title': msg,
                'class': this.get.helpSpanDisplay + ' ' + this.get.errorClass + ' ' + 'icon-asterisk',
    ...
    Nod = (function () {
        ...
        Nod.prototype.events = function () {
            ...
            if (this.submit.length) {
                ...
                return this.form.on('blur', this.listenForEnter);
                return this.form.on('focus', this.listenForEnter);
            }
        };
