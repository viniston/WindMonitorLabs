...
(function ($, undefined) {
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        initContainer: function () {
            ...
            this.search.on("input paste", this.bind(function () {
                $(this.selection.find('.select2-input')).val(strip($(this.selection.find('.select2-input')).val()));
                if (!this.isInterfaceEnabled()) return;
                if (!this.opened()) {
                    this.open();
                }
    ...
    $.fn.select2.defaults = {
        ...
        formatInputTooShort: function (input, min) { var n = min - input.length; return "Please type and press enter"; },
